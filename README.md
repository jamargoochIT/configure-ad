...
Now, let’s get started by logging into DC-1 and in the server manager dashboard click on 2. Add roles and features. <br><br><br><br>
![1](https://github.com/user-attachments/assets/e7bdf61b-d998-42e6-9d97-a18d182dffc8)

 

In the installation window that opens up select next. 
![2](https://github.com/user-attachments/assets/fd7db18d-2655-49c1-95ee-30e89da375eb)
...
Then click next.
![3](https://github.com/user-attachments/assets/cd2eadee-2069-41a3-8389-17d9f2e6c1b0)
...
![4](https://github.com/user-attachments/assets/3f318f6b-6e22-4774-9581-48c6f6145324)
...
![5](https://github.com/user-attachments/assets/5f391940-3630-4a31-b239-46d54dd7b225)


 

Click Add features then click next.
![6](https://github.com/user-attachments/assets/49251153-ca32-4fd9-9e4c-c76a3421647e)

 

Click next.
![7](https://github.com/user-attachments/assets/fdb41c92-0a04-41af-8bae-9d8935c399c3)

 

Simply click next.
![8](https://github.com/user-attachments/assets/1f309862-5c59-4278-af16-eb116ae06a35)
...
![9](https://github.com/user-attachments/assets/13dc22dd-9b22-4b87-8019-2f22de4c6c1d)


After the installation is complete, click close and go back to the server manager dashboard.

![10](https://github.com/user-attachments/assets/ead891c9-d861-4c1f-9d60-f19bf8d02b82)
...
![11](https://github.com/user-attachments/assets/5892c5f6-f9ef-49ec-a516-b920ec9ed4ae)
...
![12](https://github.com/user-attachments/assets/c1ed23da-1515-4f8f-8594-1625baa24edd)
...
![13](https://github.com/user-attachments/assets/4c3b36e5-3fbd-4197-8fe1-a224adc15362)



We do not want to create a DNS delegation, so we have to make sure this box is unchecked before we click next.
![14](https://github.com/user-attachments/assets/4e8a1dbe-39fc-4d49-9e2e-339903f1fe8e)



We’ll click next again.
![15](https://github.com/user-attachments/assets/535af41f-95bb-4fc7-a7e0-d56a0beabdb5)


We’ll click next again
![16](https://github.com/user-attachments/assets/74c2bc9c-507f-43d7-80ae-8de0a1eb004e)



Next again.
![17](https://github.com/user-attachments/assets/cbb5c0a4-8128-49a8-897f-32eb28307441)
...
When the installation is finished the VM will restart. 
...
![19](https://github.com/user-attachments/assets/157f2ca3-0b0e-47c2-9949-9854756dcb69)
...
![20](https://github.com/user-attachments/assets/015855aa-888b-4f34-b011-477895d9dc7f)



Name the organizational unit Employees, then click okay.
We’ll follow the same process to create another OU named Admins.
![21](https://github.com/user-attachments/assets/ecd9dab2-f046-4a23-9876-1f311c69aadb)
...
![22](https://github.com/user-attachments/assets/eced69c5-c6f8-42a5-a05f-971c5d807ded)


We’ll create a password and select any of the options below if we want. 

![23](https://github.com/user-attachments/assets/52ab79aa-4037-43a4-b6e7-d3f04283c5f8)
...
![24](https://github.com/user-attachments/assets/2df5edb8-d2ce-4194-a9cc-5b08223535f5)
...
![25](https://github.com/user-attachments/assets/17f0fe09-4efd-4f9c-8f13-e4206def4b30)



In the new window, type Domain Admins then click check name, click ok, click apply, and then ok.
![26](https://github.com/user-attachments/assets/0db4a18d-244a-4f58-91e8-a582e05efe04)

![27](https://github.com/user-attachments/assets/de8f7ae3-e820-458e-b914-c406d10137e3)
...
![28](https://github.com/user-attachments/assets/f42323da-5f0f-40c9-a5d6-c2dacc34f555)



Once we’ve logged in, we can move on to the next big step. 
![29](https://github.com/user-attachments/assets/e37f68e1-722f-4e08-801c-19fea20b7a8c)
...
![30](https://github.com/user-attachments/assets/d87b99df-a69b-4caa-8074-5ac3394cde0e)



In the new window that opens, we’ll click on rename this PC (advanced).
![31](https://github.com/user-attachments/assets/a70b70bf-cefc-4e0c-a54a-0a42b5dfa8af)



Click change.
![32](https://github.com/user-attachments/assets/e77249e5-bfdc-4baf-a463-b4db20cdc5f4)



Click Domain under Member Of.

![33](https://github.com/user-attachments/assets/80511dc7-a5d6-4489-98e3-f443d76fdfd4)



Type in mydomain.com or what name you chose.

![34](https://github.com/user-attachments/assets/139cda25-ae95-46d2-a96d-d2291a82ce7e)
...
![35](https://github.com/user-attachments/assets/ed9dd93a-44cb-460a-80b7-da559ad862af)


Then click OK.
![36](https://github.com/user-attachments/assets/0f91b5d9-4bd9-401f-997b-0a0a90a7299f)


After you click OK, we’ll get a message stating that we’ll need to restart the Client-1 VM.
Click OK and then close.
![37](https://github.com/user-attachments/assets/d9f8e2ac-c2fd-4d82-b9b1-cec6db696295)
...
![30](https://github.com/user-attachments/assets/8e00bdeb-9ce2-45f1-bcda-9187a54273bb)




Now we’ll click on remote desktop.
<img width="906" alt="41" src="https://github.com/user-attachments/assets/5a4ca29f-4e91-4e49-9c7c-ff026d9789f9">


Under User Accounts, click on select users that can remotely access this PC.

<img width="904" alt="42" src="https://github.com/user-attachments/assets/81e5c1bd-f308-407b-8fa7-af899a658614">



In the window that opens, we’ll click on Add.

<img width="286" alt="43" src="https://github.com/user-attachments/assets/deaa8c77-a1a0-4b1d-9396-ad061d0ee7e6">



Then we’ll type in Domain Users and click check name and then OK.
<img width="352" alt="44" src="https://github.com/user-attachments/assets/da99301c-217b-4e28-a828-edf2bceee228">
...
<img width="279" alt="45" src="https://github.com/user-attachments/assets/6ee37b59-779b-4588-bf81-990f37a07ab4">
